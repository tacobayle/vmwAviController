...
variable "contentLibrary" {
  default = {
    ...
    file = "/home/ubuntu/bin/controller-21.1.1-9045.ova" # don't change the file name format - it is used to retrieve the Avi version automatically
  }
}
...
variable "controller" {
  default = {
    ...
    folder = "NicWorkshopNewControlers"
    mgmt_ips = ["10.41.134.127", "10.41.134.128", "10.41.134.129"] # if dhcp use the following instead: ["", "", ""]
